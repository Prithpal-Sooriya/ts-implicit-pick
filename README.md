...
![Example of Partial](https://raw.githubusercontent.com/Prithpal-Sooriya/ts-implicit-pick/main/images/PartialExample.png)
...
- `(props: Pick<T, K>): Pick<T, K>`
  ...
  - Invalid values for the key will give us an error, since it won't match the `Pick`ed object values.
...
![Implicit Pick with no IntelliSense](https://raw.githubusercontent.com/Prithpal-Sooriya/ts-implicit-pick/main/images/ImplicitPickNoAutoComplete.png)
...
![Implicit Pick With IntelliSense info for the keys](https://raw.githubusercontent.com/Prithpal-Sooriya/ts-implicit-pick/main/images/ImplicitPickAutoCompleteKey.png)
...
![Implicit Pick With IntelliSense info for the value](https://raw.githubusercontent.com/Prithpal-Sooriya/ts-implicit-pick/main/images/ImplicitPickAutoCompleteValue.png)
